 ...
 *
 * $Id: transfer.c,v 1.71.2.2 2001-12-17 23:10:28 bagder Exp $
 *****************************************************************************/
...
Transfer(struct connectdata *conn)
{
  ...
  struct Curl_Transfer_Keeper moooot;

#if 0
  k = (struct Curl_Transfer_Keeper *)
    malloc(sizeof(struct Curl_Transfer_Keeper));
