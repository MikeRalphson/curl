...
;;;; $Id: curl-style.el,v 1.6 2004-01-22 12:48:48 bagder Exp $
...
(defun curl-c-mode-common-hook ()
  ...
  (setq tab-width 8
	...
	comment-column 40
	c-font-lock-extra-types (append '("bool" "CURL" "CURLcode" "ssize_t" "size_t" "socklen_t" "fd_set" "time_t" "curl_off_t"))
	)
